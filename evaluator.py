...
def evaluate_reply(client, customer_text, ground_truth, ai_draft):
    if ai_draft == "[ESCALATED TO HUMAN AGENT]":
        return EvaluationScore(helpfulness_score=0, brand_tone_score=0, reasoning="Escalated")
    ...
    try:
        ...
        return EvaluationScore(helpfulness_score=1, brand_tone_score=1, reasoning="Evaluation Failed")
